...
class MJS2:
    ...
    def __init__(self, robot_ns, robot_model):
        ...
        self.model = mujoco.MjModel.from_xml_path(os.path.join(BASE_DIR, "resources", robot_ns, "scene.xml"))
    ...
    def get_noise_scale_vec(self):
        ...
        noise_vec_[:3] = noise_scales["ang_vel"] * noise_level * self.obs_scales["ang_vel"]
        noise_vec_[3:6] = noise_scales["gravity"] * noise_level
        noise_vec_[6:12] = noise_scales["dof_pos"] * noise_level * self.obs_scales["dof_pos"]
        noise_vec_[12:18] = noise_scales["dof_vel"] * noise_level * self.obs_scales["dof_vel"]
        noise_vec_[18:24] = 0.0  # previous actions
        noise_vec_[24:27] = 0.0  # commands
        return noise_vec_
...
def main():
    sim = MJS2(robot_ns="TRON1", robot_model="TRON1")
    sim.run()
